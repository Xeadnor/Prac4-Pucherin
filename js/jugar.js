...
function texto(){
  ...
  function pintarCasillas() {
    var text = "";
    text += ("<div class='row justify-content-center'><div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[0].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[0].fichasRellenas + "/" + arrayPucheros[0].fichasCapacidad +  "</div>");
    text +=  ("<div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[1].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[1].fichasRellenas + "/" + arrayPucheros[1].fichasCapacidad +  "</div>" + "</div>")

    text += ("<div class='row justify-content-center'><div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[2].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[2].fichasRellenas + "/" + arrayPucheros[2].fichasCapacidad +  "</div>");
    text +=  ("<div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[3].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[3].fichasRellenas + "/" + arrayPucheros[3].fichasCapacidad +  "</div>" + "</div>")

    text += ("<div class='row justify-content-center'><div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[4].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[4].fichasRellenas + "/" + arrayPucheros[4].fichasCapacidad +  "</div>");
    text +=  ("<div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[5].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[5].fichasRellenas + "/" + arrayPucheros[5].fichasCapacidad +  "</div>" + "</div>")

    text += ("<div class='row justify-content-center'><div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[6].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[6].fichasRellenas + "/" + arrayPucheros[6].fichasCapacidad +  "</div>");
    text +=  ("<div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[7].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[7].fichasRellenas + "/" + arrayPucheros[7].fichasCapacidad +  "</div>" + "</div>")

    text += ("<div class='row justify-content-center'><div class='col-6 col-sm-2 border'> Casilla " + arrayPucheros[8].fichasCapacidad + " </div><div class='col-6 col-sm-2 border'> Fichas:" + arrayPucheros[8].fichasRellenas + "/" + arrayPucheros[8].fichasCapacidad +  "</div>" + "</div>")
